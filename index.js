...
app.use('/service1', express.static('tmp/avgen'));
app.use('/service2', express.static('tmp/avgen'));
app.use('/service3', express.static('tmp/avgen'));
app.use('/service4', express.static('tmp/avgen'));
